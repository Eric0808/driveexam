...
<title><?php if( isset($title) && !empty($title) ) echo $title, ' | '; ?><?php echo $this->config->item('texam_site_name'); ?></title>
	...
	<div class="header_t">
		<div class="logo">
			<a href="<?php echo $this->config->config['Domain']; ?>">
				<img src="<?php echo STATIC_IMG_PATH; ?>logo.gif" width="179" height="56" border="0">
			</a>
		</div>
