...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 添加车型/科目</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td>
	<?php echo form_open('admin/drive_type/Addtype',array('target'=>'rightFrame','name'=>'myform','id'=>'myform'));?>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
		...
		<div  class="input-div2"><input type="text" value="" id="drivetype" class="input-text" name="drivetype"></div>
		</td>
      </tr>
      <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" id="subject1" class="input-text" name="subject1"></div>
		</td>
      </tr>
       <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" id="remark" class="input-text" name="remark"></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" size="3" id="bankid" class="input-text" name="bankid"></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" id="chapterid" class="input-text" name="chapterid"></div>
		</td>
      </tr>
	  <tr>
