...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<?php echo form_open('admin/news_info/Postnews',array('target'=>'rightFrame','name'=>'myform','id'=>'myform'));?>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
		...
		<div  class="input-div2"><input type="text" value="" id="title" class="input-text" name="title" style="width:400px;"></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" id="postuser" class="input-text" name="postuser" ><span style="color:red;">注：留空则默认为“管理员”</span></div>
		</td>
      </tr>
      <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
		...
		<input name="isbank" id="isbank" type="checkbox" style="margin-right:5px;" value="1" /><label for="isbank" style="margin-right:10px;">打钩为是</label>
	  ...
	  <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input name="istop" id="istop" type="checkbox" style="margin-right:5px;" value="1" /><label for="istop" style="margin-right:10px;">打钩为是</label>
		</div>
		</td>
      </tr>
       <tr>
		...
		<textarea id="elm1" name="elm1" rows="12" cols="80" style="width: 80%;height: 350;"></textarea>
		</div>
		</td>
      </tr>
	  ...
	  <tr>
		...
		<div class="input-div2" style="padding-left: 400px;"><input type="submit" value="发布文章" id="dosubmit"/></div>
		</td>
